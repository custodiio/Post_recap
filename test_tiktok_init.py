...
def test():
    ...
    # Casos de teste de truncagem
    tests_trunc = [
        ("A: trunc 2200", real_failed_title[:2200]),
        ("B: trunc 2100", real_failed_title[:2100]),
        ("C: trunc 1000", real_failed_title[:1000]),
        ("D: trunc 2200 com reticencias", real_failed_title[:2197] + "..."),
    ]
    ...
    for name, title_val in tests_trunc:
        ...
        print(f"Testando {name} (tamanho: {len(title_val)} chars)...")
